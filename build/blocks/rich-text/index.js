...
!function() {
/*!****************************************!*\
  !*** ./src/blocks/rich-text/index.tsx ***!
  \****************************************/
...
(0,_wordpress_rich_text__WEBPACK_IMPORTED_MODULE_2__.registerFormatType)('my-custom-format/sample-output-2', {
  title: 'Sample output 123',
  tagName: 'span',
  className: null,
  edit: MyCustomButton123
});
const MyCustomButton = _ref2 => {
  let {
    isActive,
    onChange,
    value
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.registerBlockType)('gutenberg-examples/example-04-controls-esnext', {
  apiVersion: 2,
